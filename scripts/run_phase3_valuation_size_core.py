...
from stock_maintainance.features.modules import build_valuation_size


ROOT = Path(__file__).resolve().parents[1]
REPORT_PATH = ROOT / "reports" / "phase3_valuation_size_core_run.jsonl"
...
def main() -> None:
    ...
    read_start = start - timedelta(days=5000)
    ...
    result = build_valuation_size(ctx)
    payload = {
        "mode": "full_once",
